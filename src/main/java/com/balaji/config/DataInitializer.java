...
public class DataInitializer implements CommandLineRunner {
    ...
    public void run(String... args) {
        log.info("========== BALAJI FRAMES DATA INITIALIZATION STARTED ==========");
        seedAdmin();
        seedFrameSizes();
        seedBeadingOptions();
        seedCoverOptions();
        log.info("========== BALAJI FRAMES DATA INITIALIZATION COMPLETED ==========");
    }
    ...
    private void seedAdmin() {
        ...
        log.info("Admin created with username: {}", adminUsername);
    }

    private void seedFrameSizes() {
        long count = frameSizeRepo.count();
        if (count > 0) {
            log.info("Frame sizes already exist ({}), skipping...", count);
            return;
        }
        ...
        log.info("Frame sizes seeded successfully: {} entries", sizes.size());
    }

    private void seedBeadingOptions() {
        long count = beadingRepo.count();
        if (count > 0) {
            log.info("Beading options already exist ({}), skipping...", count);
            return;
        }
        
        List<BeadingOption> beadings = List.of(
            BeadingOption.builder().widthLabel("0.7 inch").displayWidth("0.7 inch").widthValue(0.7)
                .additionalPrice(new BigDecimal("40")).pattern("White Gold")
            ...
            BeadingOption.builder().widthLabel("0.7 inch").displayWidth("0.7 inch").widthValue(0.7)
                .additionalPrice(new BigDecimal("45")).pattern("Coffee Ivory")
            ...
            BeadingOption.builder().widthLabel("0.7 inch").displayWidth("0.7 inch").widthValue(0.7)
                .additionalPrice(new BigDecimal("50")).pattern("Sky Blue Gold")
            ...
            BeadingOption.builder().widthLabel("1 inch").displayWidth("1 inch").widthValue(1.0)
                .additionalPrice(new BigDecimal("60")).pattern("Black T-2")
            ...
            BeadingOption.builder().widthLabel("1 inch").displayWidth("1 inch").widthValue(1.0)
                .additionalPrice(new BigDecimal("65")).pattern("Black T-3")
            ...
            BeadingOption.builder().widthLabel("1 inch").displayWidth("1 inch").widthValue(1.0)
                .additionalPrice(new BigDecimal("70")).pattern("Black T-4")
            ...
            BeadingOption.builder().widthLabel("1 inch").displayWidth("1 inch").widthValue(1.0)
                .additionalPrice(new BigDecimal("75")).pattern("Radiant Orange")
            ...
            BeadingOption.builder().widthLabel("1 inch").displayWidth("1 inch").widthValue(1.0)
                .additionalPrice(new BigDecimal("75")).pattern("Radiant Red")
                .gradientCss("linear-gradient(135deg,#000000 0%,#DC143C 25%,#FF1493 50%,#C71585 75%,#8B0000 100%)")
                .description("Radiant Red - Bold passion").borderPx(8).build(),
            
            BeadingOption.builder().widthLabel("1 inch").displayWidth("1 inch").widthValue(1.0)
                .additionalPrice(new BigDecimal("80")).pattern("Tiger Pattern")
                ...
                .description("Tiger Pattern - Wild stripes").borderPx(8).build(),

            BeadingOption.builder().widthLabel("1 inch").displayWidth("1 inch").widthValue(1.0)
                .additionalPrice(new BigDecimal("70")).pattern("N Wood Pin")
            ...
            BeadingOption.builder().widthLabel("1 inch").displayWidth("1 inch").widthValue(1.0)
                .additionalPrice(new BigDecimal("65")).pattern("White Gold")
            ...
            BeadingOption.builder().widthLabel("1 inch").displayWidth("1 inch").widthValue(1.0)
                .additionalPrice(new BigDecimal("70")).pattern("Sky Blue Gold")
            ...
            BeadingOption.builder().widthLabel("1 inch").displayWidth("1 inch").widthValue(1.0)
                .additionalPrice(new BigDecimal("75")).pattern("CZ RST")
            ...
            BeadingOption.builder().widthLabel("1 inch").displayWidth("1 inch").widthValue(1.0)
                .additionalPrice(new BigDecimal("70")).pattern("Rose White RST")
            ...
            BeadingOption.builder().widthLabel("1 inch").displayWidth("1 inch").widthValue(1.0)
                .additionalPrice(new BigDecimal("80")).pattern("Gold White RST")
            ...
            BeadingOption.builder().widthLabel("1 inch").displayWidth("1 inch").widthValue(1.0)
                .additionalPrice(new BigDecimal("65")).pattern("Pine Wood RST")
            ...
            BeadingOption.builder().widthLabel("1 inch").displayWidth("1 inch").widthValue(1.0)
                .additionalPrice(new BigDecimal("68")).pattern("Brown Pine RST")
                .gradientCss("linear-gradient(135deg,#3E2723 0%,#5D4037 25%,#D2B48C 50%,#C19A6B 75%,#1A0E0E 100%)")
                .description("Brown Pine RST - Dark wood").borderPx(8).build(),
            
            BeadingOption.builder().widthLabel("1 inch").displayWidth("1 inch").widthValue(1.0)
                .additionalPrice(new BigDecimal("62")).pattern("Black RST")
            ...
            BeadingOption.builder().widthLabel("1 inch").displayWidth("1 inch").widthValue(1.0)
                .additionalPrice(new BigDecimal("72")).pattern("Coffee Ivory RST")
            ...
            BeadingOption.builder().widthLabel("1 inch").displayWidth("1 inch").widthValue(1.0)
                .additionalPrice(new BigDecimal("77")).pattern("Black Brown RST")
            ...
            BeadingOption.builder().widthLabel("1.2 inch").displayWidth("1.2 inch").widthValue(1.2)
                .additionalPrice(new BigDecimal("85")).pattern("CZ Model 6")
                .gradientCss("linear-gradient(135deg,#8B4513 0%,#6B3410 25%,#D2B48C 50%,#8B4513 75%,#654321 100%)")
                .description("CZ - Rich baroque").borderPx(9).build(),
            
            BeadingOption.builder().widthLabel("1.2 inch").displayWidth("1.2 inch").widthValue(1.2)
                .additionalPrice(new BigDecimal("90")).pattern("Black Gold Model 6")
            ...
            BeadingOption.builder().widthLabel("1.25 inch").displayWidth("1.25 inch").widthValue(1.25)
                .additionalPrice(new BigDecimal("95")).pattern("Natural Louvers")
                .gradientCss("linear-gradient(135deg,#8B6F47 0%,#C19A6B 25%,#DAA520 50%,#F5DEB3 75%,#8B7355 100%)")
                .description("Natural Louvers - Elegant").borderPx(10).build(),
            
            BeadingOption.builder().widthLabel("1.25 inch").displayWidth("1.25 inch").widthValue(1.25)
                .additionalPrice(new BigDecimal("100")).pattern("CZ Model 122")
            ...
            BeadingOption.builder().widthLabel("1.25 inch").displayWidth("1.25 inch").widthValue(1.25)
                .additionalPrice(new BigDecimal("98")).pattern("Night Wood Gold")
            ...
            BeadingOption.builder().widthLabel("1.25 inch").displayWidth("1.25 inch").widthValue(1.25)
                .additionalPrice(new BigDecimal("110")).pattern("B Gold Louvers")
                .gradientCss("linear-gradient(135deg,#000000 0%,#8B4513 25%,#DAA520 50%,#F5DEB3 75%,#000000 100%)")
                .description("B Gold Louvers - Premium").borderPx(10).build(),
            
            BeadingOption.builder().widthLabel("1.25 inch").displayWidth("1.25 inch").widthValue(1.25)
                .additionalPrice(new BigDecimal("105")).pattern("B Pinewood")
            ...
            BeadingOption.builder().widthLabel("1.25 inch").displayWidth("1.25 inch").widthValue(1.25)
                .additionalPrice(new BigDecimal("108")).pattern("B Louvers")
            ...
            BeadingOption.builder().widthLabel("1.25 inch").displayWidth("1.25 inch").widthValue(1.25)
                .additionalPrice(new BigDecimal("112")).pattern("B Gold Pine")
                .gradientCss("linear-gradient(135deg,#000000 0%,#FFD700 25%,#F5DEB3 50%,#F0F8FF 75%,#000000 100%)")
                .description("B Gold Pine - Contrast").borderPx(10).build(),
            
            BeadingOption.builder().widthLabel("1.25 inch").displayWidth("1.25 inch").widthValue(1.25)
                .additionalPrice(new BigDecimal("115")).pattern("Gold Black T1")
                .gradientCss("linear-gradient(135deg,#DAA520 0%,#1a1a1a 25%,#2a2a2a 50%,#1a1a1a 75%,#000000 100%)")
                .description("Gold Black T1 - Bold modern").borderPx(10).build(),
            
            BeadingOption.builder().widthLabel("1.25 inch").displayWidth("1.25 inch").widthValue(1.25)
                .additionalPrice(new BigDecimal("118")).pattern("Black Gold T5")
                .gradientCss("repeating-linear-gradient(45deg,#000000 0px,#000000 3px,#FFD700 3px,#FFD700 6px,#1a1a1a 6px,#1a1a1a 10px)")
                .description("Black Gold T5 - Striped").borderPx(10).build(),
            
            BeadingOption.builder().widthLabel("1.25 inch").displayWidth("1.25 inch").widthValue(1.25)
                .additionalPrice(new BigDecimal("120")).pattern("CZ T1")
                .gradientCss("linear-gradient(135deg,#DAA520 0%,#8B4513 25%,#A0522D 50%,#D2B48C 75%,#654321 100%)")
                .description("CZ T1 - Warm classic").borderPx(10).build(),
            
            BeadingOption.builder().widthLabel("1.25 inch").displayWidth("1.25 inch").widthValue(1.25)
                .additionalPrice(new BigDecimal("122")).pattern("B Gold Tiger T1")
                .gradientCss("repeating-linear-gradient(45deg,#1a1a1a 0px,#1a1a1a 3px,#FFD700 3px,#FFD700 6px,#8B4513 6px,#8B4513 10px)")
                .description("B Gold Tiger - Wild glam").borderPx(10).build(),

            BeadingOption.builder().widthLabel("1.25 inch").displayWidth("1.25 inch").widthValue(1.25)
                .additionalPrice(new BigDecimal("100")).pattern("Natural Louvers M33")
                .gradientCss("linear-gradient(135deg,#8B6F47 0%,#C19A6B 25%,#DAA520 50%,#F5DEB3 75%,#8B7355 100%)")
                .description("Natural Louvers - Organic").borderPx(10).build(),
            
            BeadingOption.builder().widthLabel("1.25 inch").displayWidth("1.25 inch").widthValue(1.25)
                .additionalPrice(new BigDecimal("102")).pattern("Pin wood Black")
                .gradientCss("linear-gradient(135deg,#F5DEB3 0%,#D2B48C 25%,#000000 50%,#1a1a1a 75%,#F5F5DC 100%)")
                .description("Pin wood Black - Mixed").borderPx(10).build(),
            
            BeadingOption.builder().widthLabel("1.25 inch").displayWidth("1.25 inch").widthValue(1.25)
                .additionalPrice(new BigDecimal("105")).pattern("Black Gold M33")
            ...
            BeadingOption.builder().widthLabel("1.25 inch").displayWidth("1.25 inch").widthValue(1.25)
                .additionalPrice(new BigDecimal("108")).pattern("Full Black M33")
                .gradientCss("linear-gradient(135deg,#000000 0%,#1a1a1a 25%,#2a2a2a 50%,#1a1a1a 75%,#000000 100%)")
                .description("Full Black - Sleek modern").borderPx(10).build(),
            
            BeadingOption.builder().widthLabel("1.25 inch").displayWidth("1.25 inch").widthValue(1.25)
                .additionalPrice(new BigDecimal("110")).pattern("Royal Brown")
                .gradientCss("linear-gradient(135deg,#8B1A1A 0%,#A0522D 25%,#8B4513 50%,#D2B48C 75%,#3E2723 100%)")
                .description("Royal Brown - Deep rich").borderPx(10).build(),
            
            BeadingOption.builder().widthLabel("1.25 inch").displayWidth("1.25 inch").widthValue(1.25)
                .additionalPrice(new BigDecimal("112")).pattern("Maroon Gold")
            ...
            BeadingOption.builder().widthLabel("1.25 inch").displayWidth("1.25 inch").widthValue(1.25)
                .additionalPrice(new BigDecimal("115")).pattern("Maroon Gold T6")
                ...
                .description("Maroon Gold T6 - Textured").borderPx(10).build()
        );
        
        beadingRepo.saveAll(beadings);
        log.info("Beading/Moulding options seeded successfully: {} entries", beadings.size());
    }

    private void seedCoverOptions() {
        long count = coverRepo.count();
        if (count > 0) {
            log.info("Cover options already exist ({}), skipping...", count);
            return;
        }
        ...
        log.info("Cover/Payment options seeded successfully: {} entries", covers.size());
    }
}
